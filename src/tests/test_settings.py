...
class TestSettings(unittest.TestCase):
    ...
    def test_get_host_keys_settings(self):
        ...
        self.assertEqual(dic["system_host_keys"], load_host_keys(os.path.expanduser("~/.ssh/known_hosts")))
        ...
        self.assertEqual(dic2["system_host_keys"], load_host_keys(options.syshostfile))
    ...
    def test_get_policy_setting(self):
        ...
        try:
            ...
            self.assertFalse(settings["host_keys"] and settings["system_host_keys"])
        else:
