...
class TestMixinHandler(unittest.TestCase):
    def test_is_forbidden(self):
        ...
        context = Mock(address=("8.8.8.8", 8888), trusted_downstream=["127.0.0.1"], _orig_protocol="http")
        hostname = "4.4.4.4"
        self.assertTrue(mhandler.is_forbidden(context, hostname))

        context = Mock(address=("8.8.8.8", 8888), trusted_downstream=[], _orig_protocol="http")
        ...
        context = Mock(address=("192.168.1.1", 8888), trusted_downstream=[], _orig_protocol="http")
        hostname = "www.google.com"
    ...
    def test_get_redirect_url(self):
        ...
        self.assertEqual(mhandler.get_redirect_url(hostname, port, uri=uri), "https://www.example.com/")

        port = 4433
        self.assertEqual(mhandler.get_redirect_url(hostname, port, uri), "https://www.example.com:4433/")
